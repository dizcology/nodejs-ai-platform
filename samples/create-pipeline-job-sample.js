...
async function main(project, location, displayName, pipelineJobId) {
  // [START aiplatform_create_pipeline_job_sample]
  // const project = 'PROJECT';
  // const location = 'LOCATION';
  // const displayName = 'DISPLAY_NAME';
  // const pipelineJobId = 'PIPELINE_JOB_ID';
  ...
  async function createPipelineJobSample() {
