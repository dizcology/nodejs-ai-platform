...
async function main(project, location, displayName, gcsUri) {
  // [START aiplatform_create_dataset_tabular_gcs_sample]
  // const project = 'PROJECT';
  // const location = 'LOCATION';
  // const displayName = 'DISPLAY_NAME';
  // const gcsUri = 'GCS_URI';
  ...
  async function createDatasetTabularGcsSample() {
            ...
            structValue: {
              fields: {
                gcs_source: {
                  structValue: {
                    fields: {
                      uri: { listValue: { values: [{ stringValue: gcsUri }] } },
                    },
                  },
                },
              },
  ...
  await createDatasetTabularGcsSample();
