...
async function main(project, location, hyperparameterTuningJob) {
  ...
  async function deleteHyperparameterTuningJobSample() {
    ...
    const [response] = await client.deleteHyperparameterTuningJob(request);
  ...
  await deleteHyperparameterTuningJobSample();
