...
async function main(project, location, dataset, annotationSpec) {
  ...
  async function getAnnotationSpecSample() {
    const name = `projects/${project}/locations/${location}/datasets/${dataset}/annotationSpecs/${annotation_spec}`;
