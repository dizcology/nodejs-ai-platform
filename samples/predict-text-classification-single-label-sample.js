...
async function main(project, location, endpoint, content) {
  ...
  async function predictTextClassificationSingleLabelSample() {
  ...
  await predictTextClassificationSingleLabelSample();
