...
async function main(context, childContext) {
  // [START aiplatform_add_context_children_sample]
  // const context = 'CONTEXT';
  // const childContext = 'CHILD_CONTEXT';
  ...
  async function addContextChildrenSample() {
    const childContexts = [childContext];
    const request = {
      context,
      childContexts,
    };
  ...
  await addContextChildrenSample();
