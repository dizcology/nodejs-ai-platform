...
async function main(
  ...
  // const tensorboardExperimentId = 'TENSORBOARD_EXPERIMENT_ID';
  ...
  async function createTensorboardExperimentSample() {
    const parent = `projects/${project}/locations/${location}/tensorboards/${tensorboard}`;
  ...
  await createTensorboardExperimentSample();
