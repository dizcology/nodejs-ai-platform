...
async function main(specialistPoolName, newDisplayName) {
  // [START aiplatform_update_specialist_pool_sample]
  // const specialistPoolName = 'SPECIALIST_POOL_NAME';
  ...
  async function updateSpecialistPoolSample() {
    ...
    const [response] = await client.updateSpecialistPool(request);
  ...
  await updateSpecialistPoolSample();
