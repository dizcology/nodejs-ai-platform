...
async function main(project, location, displayName, bigqueryUri) {
  // [START aiplatform_create_dataset_tabular_bigquery_sample]
  // const project = 'PROJECT';
  // const location = 'LOCATION';
  // const displayName = 'DISPLAY_NAME';
  // const bigqueryUri = 'BIGQUERY_URI';
  ...
  async function createDatasetTabularBigquerySample() {
  ...
  await createDatasetTabularBigquerySample();
