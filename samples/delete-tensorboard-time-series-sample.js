...
async function main(
  ...
  async function deleteTensorboardTimeSeriesSample() {
    ...
    const [response] = await client.deleteTensorboardTimeSeries(request);
  ...
  await deleteTensorboardTimeSeriesSample();
