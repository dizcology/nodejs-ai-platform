...
async function main(project, location, featurestore, entityType, description) {
  ...
  async function createFeatureSample() {
    const parent = `projects/${project}/locations/${location}/featurestores/${featurestore}/entityTypes/${entity_type}`;
