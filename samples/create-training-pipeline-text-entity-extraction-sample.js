...
async function main(
  ...
  async function createTrainingPipelineTextEntityExtractionSample() {
    const parent = `projects/${project}/locations/${location}`;

    const trainingTaskInputs = { structValue: { fields: {} } };
  ...
  await createTrainingPipelineTextEntityExtractionSample();
