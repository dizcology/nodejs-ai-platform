...
async function main(project, location, metadataStore, context) {
  ...
  async function deleteContextSample() {
    const name = `projects/${project}/locations/${location}/metadataStores/${metadata_store}/contexts/${context}`;
