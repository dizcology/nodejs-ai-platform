...
async function main(project, location, model, evaluation) {
  ...
  async function listModelEvaluationSlicesSample() {
    const parent = `projects/${project}/locations/${location}/models/${model}/evaluations/${evaluation}`;
  ...
  await listModelEvaluationSlicesSample();
