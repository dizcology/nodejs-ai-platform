...
async function main(project, location, index) {
  ...
  async function deleteIndexSample() {
    const name = `projects/${project}/locations/${location}/indexes/${index}`;
