...
async function main(name, displayName) {
  ...
  async function updateModelDeploymentMonitoringJobSample() {
    ...
    const [response] = await client.updateModelDeploymentMonitoringJob(request);
  ...
  await updateModelDeploymentMonitoringJobSample();
