...
async function main(project, location, metadataStore, artifact) {
  ...
  async function getArtifactSample() {
    const name = `projects/${project}/locations/${location}/metadataStores/${metadata_store}/artifacts/${artifact}`;
