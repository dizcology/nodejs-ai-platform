...
async function main(
  ...
  // const annotationSetName = 'ANNOTATION_SET_NAME';
  ...
  async function createDataLabelingJobImageSegmentationSample() {
    ...
    const dataLabelingJob = {
      ...
      inputs,
      annotationLabels: {
        "aiplatform.googleapis.com/annotation_set_name": annotationSetName,
      },
    };
    const request = {
      parent,
  ...
  await createDataLabelingJobImageSegmentationSample();
