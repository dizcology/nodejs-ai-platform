...
async function main(
  ...
  async function createBatchPredictionJobVideoObjectTrackingSample() {
    const parent = `projects/${project}/locations/${location}`;

    const modelParameters = {
      structValue: {
        fields: {
          confidenceThreshold: { numberValue: 0.0 },
        },
      },
    };
  ...
  await createBatchPredictionJobVideoObjectTrackingSample();
